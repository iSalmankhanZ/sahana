                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            //this is the name gotten from the Google Account, you can choose to store this in a Shared pref and use in all activities or whatever
                            ...
                            i.putExtra("Photo",user2.getPhotoUrl());
                            startActivity(i);

                            Intent j = new Intent(LoginActivity.this,MakeBooking.class);
                            j.putExtra("userName",user.getDisplayName()); //just passing the name to the next activity
                            j.putExtra("Email",user1.getEmail());
                            startActivity(j);
